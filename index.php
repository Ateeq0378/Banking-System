...
<body>
        ...
        <div class="row">
          ...
          <div class="col-lg-6" data-aos="zoom-in" data-aos-delay="100">
            <div class="member d-flex align-items-start">
              <div class="pic"><img src="assets/img/team/ateeq.png" class="img-fluid"alt=""></div>
              <div class="member-info">
                <h4>Ateeq Ahmad</h4>
                <span>Chief Executive Officer (CEO)</span>
                <p>Mr. Ateeq Ahmad, A visionary leader and CEO of Modern Bank, embodies excellence and innovation.</p>
                <div class="social">
          ...
          <div class="col-lg-6 mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="member d-flex align-items-start">
              ...
              <div class="member-info">
                <h4>Shamma Khatoon</h4>
                <span>Bank Manager</span>
                <p>Miss. Shamma Khatoon, A visionary steward of finance, epitomizing excellence in the modern banking realm.</p>
                <div class="social">
                  <a href="https://github.com/Ateeq0378" target="_blank">
                    <i class="ri-github-fill"></i>
                  </a>
  ...
  <footer id="footer">
    ...
    <div class="container footer-bottom clearfix">
      ...
      <div class="credits">
        Designed & Developed by <a href="index.php">Ateeq Ahmad & Shamma Khatoon</a>
      </div>
    </div>
  </footer>
